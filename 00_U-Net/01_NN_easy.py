...
X_train_full = np.load(path + 'X_train_easy.npy')

y_train_full = np.load(path + 'y_train_easy.npy')
...
model.save(save_path + 'model_trained_easy')
np.save(save_path + 'loss_easy', history_weight.history['loss'])
np.save(save_path + 'val_loss_easy', history_weight.history['val_loss'])
